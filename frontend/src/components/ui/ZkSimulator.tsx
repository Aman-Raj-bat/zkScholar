  ...
  return (
    <div className="w-full rounded-2xl bg-slate-900 text-slate-100 p-6 md:p-8 border border-slate-800 shadow-2xl relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 border-b border-slate-800 pb-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold uppercase tracking-wider mb-1">
            <Sparkles size={12} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div className="lg:col-span-5 bg-slate-950/70 p-5 rounded-xl border border-slate-800 space-y-4">
          <div className="flex items-center justify-between text-xs font-bold text-slate-400 uppercase tracking-wider">
            ...
            <span className="text-[10px] bg-violet-900/40 text-violet-300 px-2 py-0.5 rounded">
              Stay on device
            </span>
          </div>
          ...
          <div>
            <div className="flex justify-between text-sm mb-1.5">
              ...
              <span className="font-mono text-violet-400 font-bold">{gpa.toFixed(2)} / 4.0</span>
            </div>
            <input
              type="range"
              min="2.0"
          ...
          <div>
            <div className="flex justify-between text-sm mb-1.5">
              ...
              <span className="font-mono text-violet-400 font-bold">${income.toLocaleString()}</span>
            </div>
            <input
              type="range"
              min="20000"
        ...
        <div className="lg:col-span-2 flex flex-col items-center justify-center text-slate-500">
          <div className="hidden lg:flex flex-col items-center gap-2">
            ...
            <div className="w-10 h-10 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-violet-400 shadow-md">
              <ArrowRight size={18} />
            </div>
          </div>
        ...
        <div className="lg:col-span-5 bg-slate-950/70 p-5 rounded-xl border border-slate-800 space-y-3">
          ...
          <div className="bg-slate-900/90 p-3 rounded-lg border border-slate-800/80 font-mono text-xs">
            ...
            <div className="text-violet-400 font-semibold truncate select-all">{pseudoCommitment}</div>
          </div>
